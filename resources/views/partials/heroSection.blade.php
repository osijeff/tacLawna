        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('../images/hero-1.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3 class="	 animated fadeInRight delay-2s">First Slide</h3>
              <p class="	 animated fadeInUp delay-4s">This is a description for the first slide.</p>
              <button class="btn-primary animated fadeInUp delay-4s">contact us</button>
            </div>
          </div>
